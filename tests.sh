...
./cmake-build/mininn -a ELASYNC -A LENET -D CIFAR10 -n 512 -e 2000 -b 16 -l 0.005 -i 256 -d 1024 -N optimal_auto_0 | tee experiments/optimal_auto/run0.csv
./cmake-build/mininn -a ELASYNC -A LENET -D CIFAR10 -n 512 -e 2000 -b 16 -l 0.005 -i 256 -d 1024 -N optimal_auto_1 | tee experiments/optimal_auto/run1.csv
./cmake-build/mininn -a ELASYNC -A LENET -D CIFAR10 -n 512 -e 2000 -b 16 -l 0.005 -i 256 -d 1024 -N optimal_auto_2 | tee experiments/optimal_auto/run2.csv
./cmake-build/mininn -a ELASYNC -A LENET -D CIFAR10 -n 512 -e 2000 -b 16 -l 0.005 -i 256 -d 1024 -N optimal_auto_3 | tee experiments/optimal_auto/run3.csv
./cmake-build/mininn -a ELASYNC -A LENET -D CIFAR10 -n 512 -e 2000 -b 16 -l 0.005 -i 256 -d 1024 -N optimal_auto_4 | tee experiments/optimal_auto/run4.csv
