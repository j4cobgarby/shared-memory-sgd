OUT_DIR=./final_experiments/overnight_constant_semisync_vs_async
mkdir -p $OUT_DIR
...
./cmake-build/mininn -n 128 -b 16 -u 0.3 -D semisync -y 16 -z 0 -M window -F $OUT_DIR >> run_23j3.log
...
./cmake-build/mininn -n 16 -b 16 -u 0.3 -D async -M window -F $OUT_DIR >> run_23j3.log
./cmake-build/mininn -n 8 -b 16 -u 0.3 -D async -M window -F $OUT_DIR >> run_23j3.log
./cmake-build/mininn -n 4 -b 16 -u 0.3 -D async -M window -F $OUT_DIR >> run_23j3.log
