...
./cmake-build/mininn -a ELASYNC -A LENET -D CIFAR10 -n 300 -e 100 -b 16 -l 0.005 -s 300 -d 4096 -N static_tests | tee experiments/static_tests/run1.csv
./cmake-build/mininn -a ELASYNC -A LENET -D CIFAR10 -n 400 -e 100 -b 16 -l 0.005 -s 300 -d 4096 -N static_tests | tee experiments/static_tests/run2.csv
./cmake-build/mininn -a ELASYNC -A LENET -D CIFAR10 -n 500 -e 100 -b 16 -l 0.005 -s 500 -d 4096 -N static_tests | tee experiments/static_tests/run3.csv
